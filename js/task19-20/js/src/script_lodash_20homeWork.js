...
console.log('1. Массив скиллов всех людей:', sortedSkills);
...
var names = _.flatMap(sorted, function(el, i, data) {
  return el.name;
});
console.log('2. Массив имен людей, отсортированных в зависимости от количества их друзей:', names);
...
console.log('3. Массив всех друзей всех пользователей:', friends);
